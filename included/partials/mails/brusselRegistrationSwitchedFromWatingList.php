...
$body. = "<p>Máte neuvěřitelné štěstí. <br>Jeden z registrovaných uživatelů svojí registraci právě zrušil.
<br>Proto jsme si dovolili vás z čekací listiny převést na plně registrovaného</p>";
$body .= "<p>Your registration for the screening of <strong>" . $activeBrusselScreeningFilm["titleEN"] . "</strong> at <strong>" . invertDatumFromDB($activeBrusselScreening["date"], 1) . " " . $activeBrusselScreening["time"] . "</strong>, <strong>" . $activeBrusselScreeningPlace["xBrusselPlaces"] . " " . $activeBrusselScreeningPlace["address"] . "</strong> as part of the 17th edition of the One World International Human Rights Documentary Film Festival in Brussels.</p>";
