	...
	<div class="row align-center">
		<div class="medium-6 small-12 columns">
			...
			if(!empty($_POST["email"])){
				...
				if($_POST["brusselViewer2SName"]){
					$params = array(
										":screenId" 		=> $_POST["sid"],
										":fname"			=> $_POST["brusselViewer2FName"],
										":sname"			=> $_POST["brusselViewer2SName"],
										":fnameOfSigner"	=> $_POST["brusselViewerFName"],
										":snameOfSigner"	=> $_POST["brusselViewerSName"],
										":dateOfBirth"	=> "",
										":idType"			=> "",
										":idN"			=> "",
										":nationality"	=> "",
				...
				if($lang=="CZ"){
					echo "	<p>Vaše registrace na projekci proběhla úspěšně.</p>
							<p>Na vámi zadanou adresu ".$_POST["brusselViewerM"]." byl odeslán potvrzovací e-mail.</p>
							...
							<p>Děkujeme</p>
							<a class='hollow button marginBottom' href='../brusel'><b class='fi-arrow-left'></b> Zpět na program</a>
						";
				}else{
